...
Hi! I am Sandra Elsa Sanjai, a Master's student in Physics of Data at the University of Padua. My interests tend to converge onto **complex dynamical systems**, where I am specifically interested in exploring epidemiological and climate forecasting. Below is a selection of projects, both major and minor, that have influenced my growth and shaped my interests. Feel free to reach out using the provided contact information.

Mail: [sandra.e.sanjai@gmail.com](sandra.e.sanjai@gmail.com)

Note: Projects with the **(TBD)** label correspond to completed projects that have incomplete documentation or code, and requires completion.
...
-  [Temporal Difference VAE](https://github.com/Sandra-Es/Temporal_Difference_VAE) (2024): Built variations of Temporal VAE (VRSSM) with a Markovian latent prior, variational smoothing, and adaptive skip connections for structured sequence modeling. The hierarchical model performed +26% better than a classical CNN-based transformer model.
